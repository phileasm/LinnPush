...
#define ASSIGNED_PUSH_MODE              18
#define MAX_ASSIGNED                    ASSIGNED_PUSH_MODE
...
struct __attribute__ ((packed)) TouchInfo {
  ...
  void setPhantoms(byte, byte, byte, byte);  // set the phantom coordinates
...
struct GlobalSettings {
  ...
  unsigned short customSwitchAssignment[5];  // ASSIGNED_TAP_TEMPO, ASSIGNED_LEGATO, ASSIGNED_LATCH, ASSIGNED_PRESET_UP, ASSIGNED_PRESET_DOWN, ASSIGNED_REVERSE_PITCH_X, ASSIGNED_SEQUENCER_PLAY, ASSIGNED_SEQUENCER_PREV, ASSIGNED_SEQUENCER_NEXT, ASSIGNED_STANDALONE_MIDI_CLOCK, ASSIGNED_SEQUENCER_MUTE and ASSIGNED_PUSH_MODE
