...
void updateSwitchLeds() {
  ...
  else if (Global.switchAssignment[SWITCH_SWITCH_1] == ASSIGNED_PUSH_MODE && isSwitchPushModePressed(Global.currentPerSplit)){
    displaySwitch1 = cellOn;
  }
  ...
  else if (Global.switchAssignment[SWITCH_SWITCH_2] == ASSIGNED_PUSH_MODE && isSwitchPushModePressed(Global.currentPerSplit)){
    displaySwitch2 = cellOn;
  }
...
void paintCustomSwitchAssignmentConfigDisplay() {
  ...
  switch (Global.customSwitchAssignment[switchSelect]) {
    ...
    case ASSIGNED_SEQUENCER_MUTE:
      ...
      break;
    case ASSIGNED_PUSH_MODE:
      adaptfont_draw_string(0, 0, "PUSH", globalColor, true);
      break;
  }
}
